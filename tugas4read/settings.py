"""
Django settings for tugas4 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-))4g5-a3&+2!ot^sc$#wqfl1nid%zi#_566&m*ik*rbo49v#w^')
...
if not PRODUCTION:
    ALLOWED_HOSTS += ['.localhost', '127.0.0.1', '[::1]', '34.136.210.30']
...
WSGI_APPLICATION = 'tugas4read.wsgi.application'
